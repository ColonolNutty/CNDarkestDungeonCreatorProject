...
public class MESettingsDisplay extends SettingsDisplayBase {
    private ConfigWriter _writer;
    private MESettings _settings;

    public MESettingsDisplay(ConfigWriter writer, MESettings settings) {
        _writer = writer;
    ...
    public JPanel setup(ActionListener onRun) {
        ...
        JButton runButton = createButton("Save", onRun);
